...
(function (TryHSP) {
    ...
    function compile(run) {
        ...
        console.log("hsc_ini");
        Module.ccall("hsc_ini", "number", ["number", "number", "number", "number"], [0, bufPtr, 0, 0]);
        console.log("hsc_comp");
        var st = Module.ccall("hsc_comp", "number", ["number", "number", "number", "number"], [0, 0, 0, 0]);
        console.log("compile result", st);
        var mesPtr = Module._malloc(0x1000);
        Module.ccall("hsc_getmes", "number", ["number", "number", "number", "number"], [mesPtr, 0, 0, 0]);
